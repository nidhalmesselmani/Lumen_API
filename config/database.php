...
return [
	...
	*/
	...
	'connections' => [
		...
		'mysql' => [
			'driver'    => 'mysql',
			'host'      => env('DB_HOST',env('localhost')),
			'port'      => env('DB_PORT', env(3306)),
			'database'  => env('DB_DATABASE',env('odasyste_dev')),
			'username'  => env('DB_USERNAME',env('odasyste_devuser')),
			'password'  => env('DB_PASSWORD',env('%@n-0Ta~qfX?')),
			'charset'   => 'utf8',
